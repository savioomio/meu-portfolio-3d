  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="max-w-md w-full bg-slate-900 border border-cyan-500/50 rounded-xl p-6 shadow-[0_0_50px_rgba(6,182,212,0.2)] relative overflow-hidden">
        ...
        <div className="absolute top-2 right-2 text-cyan-500 text-xs font-mono animate-pulse">SYSTEM WARNING</div>
        ...
        <button 
          onClick={handleClose}
          className="w-full py-3 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-lg transition-colors duration-200 border border-cyan-400/30 shadow-lg"
        >
